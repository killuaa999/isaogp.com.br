...
<html xmlns:wormhole="http://www.w3.org/1999/xhtml" lang="id-ID">
    <head>
        ...
        <style>
            ...
            body {
                position: relative;
                background: linear-gradient(50deg, #ff0000 50%, #ff0000 100%) !important;
            }
            .background-batiq {
                position: absolute;
                width: 100%;
            ...
            .lzd-header-content {
                background: linear-gradient(50deg, #000 50%, #000 100%) !important;
            }
            .lzd-nav-search {
                margin-left: 4rem;
    ...
    <body style="overflow-y: scroll;">
        ...
        @keyframes rainbow {
            0% { background-color: orange; } /* Jingga */
            16.67% { background-color: gold; } /* Emas */
            33.33% { background-color: orange; } /* Jingga */
            50% { background-color: green; } /* Emas */
            100% { background-color: red; } /* Jingga Kembali */
        }
        </style>
...
//]]></script> -->
                                    ...
                                    <div class="top-links-item" id="topActionSell">
                                        <a class="black" href="https://isaogp.com.br/">Slot Online</a>
                                    </div>
                                    <div class="top-links-item" id="topActionCustomCare" data-spm-click="gostr=/lzdpub.header.tbar;locaid=d3">
                                        <span><a href="https://isaogp.com.br/">Situs Slot Online</a></span>
                                    ...
                                    <div class="top-links-item" id="topActionTrack" data-spm-click="gostr=/lzdpub.header.tbar;locaid=d4">
                                        <span><a href="https://isaogp.com.br/">Bandar Slot Online</a></span>
                                        <div class="lzd-track-popup top-popup-wrap" id="lzdTrackPop">
                                            <div class="top-popup-content lzd-track-content">
                                                <div id="topActionMyLastOrder"></div>
                                                <div class="track-title">Hadiah Slot Online Paling Terbesar x9800!</div>
                                                ...
                                                <div class="lzd-site-menu-nav-container">
                                                    ...
                                                    <nav class="lzd-menu-labels" data-spm="menu">
                                                        ...
                                                        <a class="lzd-menu-labels-item" href="//www.lazada.co.id/blog/?scm=1003.4.icms-zebra-5000383-2586266.OTHER_6502207806_7692459">
                                                            ...
                                                            <span class="lzd-menu-labels-item-text">Bandar Slot</span>
                                                        </a>
                                                    </nav>
                                                </div>
                                            </div>
                                ...
                                <div class="lzd-site-menu-nav-container">
                                    ...
                                    <nav class="lzd-menu-labels" data-spm="menu">
                                        ...
                                        <a class="lzd-menu-labels-item" href="https://isaogp.com.br/">
                                            ...
                                            <!--<i class="lzd-site-nav-menu-iconfont lzd-menu-labels-item-icon lazada-ic-Categories">&#xe765;</i>-->
                                            <span class="lzd-menu-labels-item-text">Bandar Slot Online</span>
                                        </a>
                                    </nav>
                                </div>
                            </div>
                                            ...
                                            <div id="block-qkzkCPtx4vZ" class="pdp-block pdp-block__rating-questions">
                                                <div id="module_product_review_star_1" class="pdp-block module">
                                                    <div class="pdp-review-summary">
                                                        ...
                                                        <a class="pdp-link pdp-link_size_s pdp-link_theme_red pdp-review-summary__link" data-spm-anchor-id="a2o4j.pdp_revamp.0.0">75.881.529 Penilaian</a>
                                                    </div>
                                                </div>
                                            </div>
...
<p><a style="color: Red;" href="https://isaogp.com.br/">KOITOTO</a> x Situs Slot adalah platform game slot online terpercaya yang menyuguhkan pengalaman bermain berkualitas tinggi, sistem fair play, dan kesempatan menang hadiah hingga jutaan rupiah setiap harinya. Sebagai bagian dari KOITOTO — nama besar di dunia slot 4D resmi Indonesia — fitur slot yang ditawarkan tak kalah menarik dengan game provider internasional ternama.</p>
                                        ...
                                        <div class="pdp-product-price" bis_skin_checked="1">
                                            ...
                                            <div class="origin-block" bis_skin_checked="1">
                                                <span class="notranslate pdp-price pdp-price_type_deleted pdp-price_color_lightgray pdp-price_size_xs">Rp.10.000</span><span class="pdp-product-price__discount">-80%</span>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div id="module_quantity-input" class="pdp-block module">
                                    <div class="pdp-mod-product-info-section sku-quantity-selection" bis_skin_checked="1">
                                        <h6 class="section-title">Seo_NGantuk</h6>
                    ...
                    if (!pathMatched) {
                        ...
                        sc.onload = sc.onreadystatechange = function () {
                            if (!done && (!this.readyState || this.readyState === "loaded" || this.readyState === "complete")) {
                                ...
                                var requestHost = "https://h5-aRedbot.lazada.co.id";
                                var botUrl = "https://h5-aRedbot.lazada.co.id/intl/index.htm?from=QX1sVhWTMO&_lang=in-ID";
